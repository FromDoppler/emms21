...
<head>
	...
	<title>EMMS 2021: ¡Revive la Conferencia de Paola Aldaz Biere!</title>
	...
	<meta name="description" content="Leader Challenge, experiencia y conocimiento para formar generaciones de líderes a través del ejemplo. ¡Revive la Conferencia!">
...
<body class="dp-library speakers-post" id="body">
	...
	<main class="main">
		<div class="dp-container-fluid" id="header">
			...
			<div class="dp-container speaker-post-container paola">
				<h1>Leader Challenge, experiencia y conocimiento para formar generaciones de líderes a través del ejemplo</h1>
				<div class="dp-rowflex">
					<div class="col-sm-1 dp-none-desktop"></div>
					<div class="col-sm-10 col-md-12 col-lg-9 dp--center">
						<div id="currentState" speaker="paola-aldaz-biere" class="video-speaker-container"></div>
					</div>
					<div class="col-sm-1 dp-none-desktop"></div>

					<div class="col-sm-12 col-md-12 col-lg-3 dp--center">
						<div class="speaker-info-post">
							<h5>Paola Aldaz Biere</h5>
							<p>Top Executive en el campo de la innovación, el desarrollo empresarial y la transformación a través del poder de la tecnología digital. Ha administrado presupuestos millonarios para las principales marcas del mundo y liderado los equipos más eficientes para alcanzar grandes resultados.</p>
							<div class="speaker-redes-post">
								<a href="https://www.linkedin.com/in/paola-aldaz/" target="_blank" rel="nofollow"><img src="img/speakers-post/linkedin.svg" alt="Linkedin"></a>
							</div>
						</div>
					</div>
				</div>
