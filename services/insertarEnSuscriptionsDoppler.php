...
function saveSuscriptionDoppler($suscription)
{
    ...
    $fields = "(email, list, form_id, invito_dos_personas, email_anfitrion, register, nombre, apellido, pais, telefono, empresa, ip, pais_ip, politica, ";
