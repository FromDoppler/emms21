...
function saveRegistrado($usuario)
{
    ...
    if ($registrado->fetchArray()) {
        //update
        $fields = "SET invito_dos_personas ='" . $usuario['invito_dos_personas'] . "', nombre ='" . $usuario['nombre'] . "', apellido ='" . $usuario['apellido'] . "', register ='" . $usuario['register'] . "', ";
        ...
        $fields = "(email, nombre, apellido, invito_dos_personas, register, pais, telefono, empresa,";
        $fields .= "source_utm, medium_utm, campaign_utm, content_utm, term_utm)";
        $values = array(
            $usuario['email'],
            $usuario['nombre'],
            $usuario['apellido'],
            $usuario['invito_dos_personas'],
            $usuario['register'],
            $usuario['pais'],
            $usuario['telefono'],
            $usuario['empresa'],
