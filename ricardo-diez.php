...
<head>
	...
	<title>EMMS 2021: ¡Revive la Conferencia de Ricardo Díez!</title>
	...
	<meta name="description" content="Big Data para Managers: Qué es Zero Party Data y por qué es importante para tu negocio. ¡Revive la Conferencia!">
...
<body class="dp-library speakers-post" id="body">
	...
	<main class="main">
		<div class="dp-container-fluid" id="header">
			...
			<div class="dp-container speaker-post-container ricardo">
				<h1>Big Data para Managers: Qué es Zero Party Data y por qué es importante para tu negocio</h1>
				<div class="dp-rowflex">
					...
					<div class="col-sm-12 col-md-12 col-lg-3 dp--center">
						<div class="speaker-info-post">
							<h5>Ricardo Díez</h5>
							<p>Fanático del Analytics, Big Data y Machine Learning, Ricardo es graduado de MIT -Massachusetts Institute of Technology-. Fundador y Director de Analytics Town ha realizado publicaciones en Forbes y Entrepreneur en español.</p>
							<div class="speaker-redes-post">
								<a href="https://www.linkedin.com/in/ricardodiez/" target="_blank" rel="nofollow"><img src="img/speakers-post/linkedin.svg" alt="Linkedin"></a>
								<a href="https://twitter.com/Ricardiez" target="_blank" rel="nofollow"><img src="img/speakers-post/twitter.svg" alt="Twitter"></a>
							</div>
						</div>
					</div>
				</div>
