			...
			<div class="dp-rowflex">
				<div class="col-sm-12 col-md-12 col-lg-12">
					<div class="live-container">
						...
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/<?= $settings['youtube'] ?>?autoplay=1&mute=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					</div>
					<div class="chat">
